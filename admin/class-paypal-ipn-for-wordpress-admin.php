...
class AngellEYE_Paypal_Ipn_For_Wordpress_Admin {
    ...
    public function admin_enqueue_scripts() {
         ...
         */
        wp_enqueue_script('run_prettify', 'https://google-code-prettify.googlecode.com/svn/loader/run_prettify.js', array('jquery'), $this->version, false);
        wp_enqueue_script($this->plugin_name, plugin_dir_url(__FILE__) . 'js/paypal-ipn-for-wordpress-admin.js', array('jquery'), $this->version, false);
    }
